...
/**
 *   This class provides support for the zenithal/azimuthal equidistant 
 *   projection (ARC) used by the FITS "World Coordinate System" (WCS) 
 *   convention. <p>
 *
...
public class ARCProjection extends Projection {
     ...
     */
    public ARCProjection() { init(0, new double[1]); }

    /**
     * Create an ARCProjection object
     * @param r0 sphere radius
     */
    public ARCProjection(double r0) { init(r0, new double[1]); }
     ...
     */
    public ARCProjection(double r0, double[] p) 
    {
	init(r0, p);
    }
