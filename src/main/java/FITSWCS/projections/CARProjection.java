...
/**
 *   This class provides support for the Cartesian projection (CAR) 
...
public class CARProjection extends Projection {
     ...
     */
    public CARProjection() { init(0, new double[1]); }

    /**
     * Create an CARProjection object
     * @param r0 sphere radius
     */
    public CARProjection(double r0) { init(r0, new double[1]); }
     ...
     */
    public CARProjection(double r0, double[] p) 
    {
	init(r0, p);
    }
